...
export default function RegisterMedicoScreen({ navigation }) {
  ...
  const handleSubmit = async () => {
    if (
      ...
      !formData.educacion ||
      !formData.afiliacion_hospitalaria ||
      !formData.tarifa_consulta ||
      !formData.password ||
    ...
    try {
      ...
      if (result.success) {
        Alert.alert("✅ Éxito", "Médico registrado correctamente");
        ...
        if (result.message.includes("email ya está registrado")) {
          ...
          Alert.alert("❌ Error", result.message || "Error al registrar médico");
        }
      }
    } catch (error) {
      console.error("Error en el registro:", error);
      Alert.alert("❌ Error", "Error inesperado al registrar médico");
    } finally {
      setLoading(false);
    }
  };
      ...
      <SafeAreaView style={styles.container}>
        ...
        <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
          <View style={styles.titleContainer}>
            <Text style={styles.title}>Crear Cuenta de Médico</Text>
            <Text style={styles.subtitle}>
              Completa los datos para crear tu cuenta médica
            </Text>
          </View>
          ...
          <View style={styles.formContainer}>
            ...
            <View style={styles.inputGroup}>
              ...
              <TextInput
                ...
                onChangeText={(value) => handleInputChange("anos_experiencia", value)}
            ...
            <View style={styles.inputGroup}>
              ...
              <TextInput
                ...
                onChangeText={(value) => handleInputChange("educacion", value)}
            ...
            <View style={styles.inputGroup}>
              <Text style={styles.label}>Afiliación Hospitalaria *</Text>
              <TextInput
                style={styles.input}
                value={formData.afiliacion_hospitalaria}
                onChangeText={(value) => handleInputChange("afiliacion_hospitalaria", value)}
                placeholder="Ingresa tu afiliación hospitalaria"
              />
            </View>
            ...
            <View style={styles.inputGroup}>
              ...
              <TextInput
                ...
                placeholder="Ingresa tu tarifa de consulta"
                keyboardType="numeric"
              />
            </View>
              ...
              >
                {loading ? (
                  ...
                  <>
                    ...
                    <Text style={styles.submitButtonText}>Registrar Médico</Text>
                  </>
                )}
              </LinearGradient>
            </TouchableOpacity>
